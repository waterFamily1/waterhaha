                ...
                <Row>
                    <Col span="24">
                        <div class="row-item">
                            ...
                            <div class="row-item-form" v-if="ifSite">
                                <div v-for="(item, index) in siteList" :key="index">
                                    <FormItem :label="'参数'+item.code">
                                        <Input 
...
<script>
import { dataKindTypeMethod, fromEqu, areaMethod, addSave1, countCycleMethod, dataSiteMethod, detailMethod2, detailMethod4, detailMethod5, detailMethod6 } from '@/api/dataManage/siteManage'
    ...
    methods: {
        getDetail() {
            ...
            detailMethod2(ids).then(res=> {
                ...
                if(res.data.datype == 'State') {
                    ...
                    this.formValidate.decimal = res.data.numtail //显示小数位
                }
        ...
        getDetail3(id) {
            ...
            detailMethod5(ids).then(res=> {
                ...
                this.formValidate.formula = res.data.formula.expression
            }).catch(err=> {
