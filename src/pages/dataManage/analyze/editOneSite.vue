...
<script>
import { dataKindTypeMethod, fromEqu, areaMethod, addSave1, countCycleMethod, countMethod, detailMethod2, detailMethod4, detailMethod6 } from '@/api/dataManage/siteManage'
    ...
    methods: {
        ...
        getDetail2() {
            ...
            detailMethod4(ids).then(res=> {
                ...
                let id = res.data.items.id
                this.formValidate.countMethod = res.data.items.formulaid.toString()
                this.formValidate.countCycle = res.data.items.cycle.toString()
        ...
        getDetail3(id) {
            ...
            detailMethod6(ids).then(res=> {
                console.log(res.data)
                this.formValidate.dataSite = res.data.items[0].mpointName
            }).catch(err=> {
