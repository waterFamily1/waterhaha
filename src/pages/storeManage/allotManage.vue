    ...
    <div class="index-box" :style="{height: height+'px'}">
        <div class="index-search" :class="{searchTrans:searchShow, searchPack:!searchShow}">
            <div class="search-main">
                <div class="form-item">
                    <label>关键字：</label>
                    <Input v-model="searchParams.queryName" placeholder="调拨单号" style="width: 300px" />
                </div>
                <div class="form-item">
                    <label>所属组织：</label> 
                    <TreeSelect 
            ...
            <div class="c-adv-search">
                <div class="c-adv-search-row">
                 ...
                 <div class="c-adv-search-row">
                    <div class="form-item">
                        <label>出库仓库：</label>
                        <Select v-model="searchParams.warehouseOutId" style="width:200px">
                ...
                <div class="c-adv-search-row">
                    <div class="form-item">
                        <label>入库仓库：</label>
                        <Select v-model="searchParams.warehouseInId" style="width:200px">
							<Option v-for="item in warehouseCombo" :value="item.warehouseNo" :key="item.warehouseNo">{{ item.warehouseName }}</Option>
						</Select>
                    </div>
                </div>
        ...
        <div class="index-content">
            <div class="c-table-top-btns">
                <Button @click="toAddCheckIn()">调拨新增</Button>
            </div> 
            <div class="table-wrapper" :style="{height: (height-45)+'px'}">
                <Table stripe :columns="tableList" :data="listData">
...
<script>
import { tableMethod, orgMethod, wareMethod, cancleMethod } from '@/api/store/allot'
...
export default {
    ...
    methods: {
        getTabel() {
            ...
            let warehouseOutId = this.searchParams.warehouseOutId
            let warehouseInId = this.searchParams.warehouseInId
