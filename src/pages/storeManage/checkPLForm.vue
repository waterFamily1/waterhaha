    ...
    <div class="index-box" :style="{height: height+'px'}">
        <div class="index-search" >
            <div class="search-main">
                ...
                <div class="form-item">
                    <label>查询时间：</label> 
                    <DatePicker type="date" placeholder="开始日期" style="width: 110px" size="small"></DatePicker>-
                    <DatePicker type="daterange" placement="bottom-end" placeholder="结束日期" style="width: 110px" size="small"></DatePicker>
                </div>
