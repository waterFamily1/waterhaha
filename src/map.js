...
export default {
	...
	placePoint: function(map, callback) {
		...
		geolocation.getCurrentPosition(function(r){
            //let point = {lng:121.480576, lat:31.235906};//默认上海
            ...
            let point = {lng:121.045562, lat:30.904412};//默认上海金山枫泾水质净化有限公司
            map.centerAndZoom(new BMap.Point(point.lng,point.lat), 17);//缩放层级修改为17
