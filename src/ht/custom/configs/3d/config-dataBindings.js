...
window.hteditor_config.dataBindings = {
    ...
    onButtonClicked: function (data, accessType, name) {
        ...
        formPane.addRow([
            S('Id'),
            {
                id: 'input',
                textField: {
                    text: editor3d.points.list.sm().isEmpty() ? id : editor3d.points.list.sm().ld().a('id')
                }
            }, {
            button: {
                label: '选择测点',
                onClicked: function (e) {
                    ...
                    function DropDownTree(master) {
                        ...
                        var map = {}, treeData = [];
                        treeData = list2tree({ pid: 'parentId' })(window.scenesList || []);
    ...
    formPane.addRow([
        S('Name'),
        {
            id: 'nameInput',
            textField: {
                text: editor3d.points.list.sm().isEmpty() ? mpointName : editor3d.points.list.sm().ld().a('name')
            }
        }
        ], [50, 0.1]);
        formPane.addRow([
            ...
            action: function () {
                ...
                if (!id) {
                    ...
                    if (data.a("id")) {
                        ...
                        data.a("id", id);
                        if (!editor3d.points.list.sm().isEmpty()) {
                            var newName = editor3d.points.list.sm().ld().a('name');
                            data.a("name", newName);
                            data.s("text", newName);
