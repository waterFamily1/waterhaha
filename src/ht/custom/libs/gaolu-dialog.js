var GaoluDialog = function GaoluDialog(editor) {
    var _this = this;
...
ht.Default.def('GaoluDialog', ht.widget.Dialog, {
    ok: function ok() {
        ...
        this.editor.request('upload', params, function (data) {
            params = {
                ...
                content: _this2.g3d.toDataURL(_this2.dm.getBackground())
            };
            _this2.editor.request('upload', params, function (data) {
                _this2.hide();
            });
        });
    },
    open: function open(url, json) {
        json = json || {
            "modelType": "gaolu",
            "class": "GaoluDialog",
            "params": [{
    ...
    initTable: function initTable(json) {
